...
const Experiance = () => {
  return (
    <div
      className="lg:px-28 px-6 lg:py-20 md:py-10 py-2 text-slate-100 bg-slate-950 dark:bg-slate-100 dark:text-slate-950"
      id="Experience"
    >
      <motion.h2
        ...
        className="main-title m-2 lg:m-3 lg:ml-20 md:ml-16 sm:ml-10  relative inline-block text-gray_gradient hover:text-white-500 transition-all dark:text-slate-900 mb-10"
      >
        Experience
      </motion.h2>
      ...
      >
        {ExperianceList.map((exp, index) => (
          <div
            key={index}
            className="flex flex-col md:flex-row items-start relative mb-10 last:mb-0"
          >
            <div className="flex ml-14 mb-4 sm:ml-0 md:flex-col items-center justify-center flex-shrink-0 w-24 gap-1">
            ...
            <div
              className={`bg-gray-800 dark:bg-slate-100 dark:text-slate-900 rounded-lg transition-transform duration-300 hover:scale-105 ease-in-out shadow-xl ml-8 font-roboto p-6`}
            >
